                    ...
                    <div class="card-body">
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" required id="password_confirmation" name="password_confirmation" type="password" placeholder="Password Confirmation">
                                    </div>
                                </div>

                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" id="" name="profile" type="file">
                                    </div>
                                </div>
                                ...
                                <div class="form-group text-center row mt-3 pt-1">
                                    <div class="col-12">
                                        <button class="btn btn-info w-100 waves-effect waves-light" name="btn_register" type="submit">Register</button>
                                    </div>
                                </div>
